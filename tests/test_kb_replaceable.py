...
def _clean(monkeypatch, tmp_path):
    ...
    import tangyuanAI.kb_reranker_factory as rfactory
...
class TestReplaceable:
    def test_replace_cache_with_null(self):
        ...
        from tangyuanAI.kb_cache import NullCache, set_global_cache, get_global_cache
    ...
    def test_replace_doc_processor(self):
        ...
        from tangyuanAI.kb_ingest import add_document_sync
        from tangyuanAI.kb_search import search_sync
        from tangyuanAI.kb_doc_processor_factory import get_processor_for
