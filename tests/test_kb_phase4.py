...
from tangyuanAI.kb_types import KnowledgeBase
from tangyuanAI.kb_config import EmbedderConfig, RerankerConfig
from tangyuanAI.kb_embedder_base import BaseEmbedder
from tangyuanAI.kb_cache import NullCache, get_global_cache, set_global_cache
...
class TestRegistry:
    def test_register_get(self):
        from tangyuanAI.kb_registry import register_kb, get_kb, list_kbs, delete_kb
    ...
    def test_delete(self):
        from tangyuanAI.kb_registry import register_kb, delete_kb, get_kb
        register_kb("demo", embedder=_fake_cfg())
    ...
    def test_persistence_restore(self):
        from tangyuanAI.kb_registry import register_kb, _kbs, get_kb
...
class TestIngestSearch:
    def test_add_and_search(self):
        from tangyuanAI.kb_registry import register_kb, get_kb
        from tangyuanAI.kb_ingest import add_document_sync
        from tangyuanAI.kb_search import search_sync
    ...
    def test_list_documents(self):
        from tangyuanAI.kb_registry import register_kb
        from tangyuanAI.kb_ingest import add_document_sync
        from tangyuanAI.kb_search import list_documents_sync
...
class TestMigrate:
    def test_migrate_switches_model(self):
        ...
        from tangyuanAI.kb_ingest import add_document_sync
        from tangyuanAI.kb_search import search_sync
        from tangyuanAI.kb_migrate import migrate_embedding_model_sync
...
class TestTool:
    def test_register_tools(self):
        from tangyuanAI.kb_registry import register_kb
        from tangyuanAI.kb_ingest import add_document_sync
        from tangyuanAI.kb_tool import register_kb_tools, unregister_kb_tools
