...
from tangyuanAI.kb_embedder_factory import create_embedder, list_embedder_providers
from tangyuanAI.kb_embedder_openai import OpenAICompatibleEmbedder
from tangyuanAI.kb_embedder_jina import JinaEmbedder
...
class TestCohereFactory:
    def test_cohere_provider(self):
        from tangyuanAI.kb_embedder_cohere import CohereEmbedder
        ...
        from tangyuanAI.kb_embedder_factory import _EMBEDDERS
...
class TestVoyageFactory:
    @patch("tangyuanAI.kb_embedder_voyage.AsyncHTTPClient")
    def test_voyage_provider(self, _):
        from tangyuanAI.kb_embedder_voyage import VoyageEmbedder
