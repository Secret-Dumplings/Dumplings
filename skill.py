...
基于 Claude Code 的 SKILL.md 规范，实现 tangyuanAI 的 Skills 系统。
...
用法:
    ...
    # 扫描并注册 skills
    tangyuanAI.skill_registry.scan_and_register([Path(".")])

    # 直接注册单个 skill 目录
    tangyuanAI.skill_registry.register_skill(Path(".claude/skills/my-skill"))
